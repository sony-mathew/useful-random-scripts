...
# This is a pretty simple script. The script downloads content of the url set, and if it finds some text, emails me.
# If it does not find some text, it waits 60 seconds and downloads the homepage again.

# while this is true (it is true by default),
while True:
    # set the url,
    url = "https://instantview.telegram.org/contest"
    ...
    if str(soup).find("extranewsfeed.com") != -1:
        # wait 60 seconds,
        time.sleep(60)
    ...
    # but if the word occurs any other number of times,
        ...
        msg = 'Subject: This is your script talking, CHECK Telegram!'
